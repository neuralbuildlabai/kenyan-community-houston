...
/** Redirects signed-in users who must rotate password before using the wrapped route. */
export function PasswordExpiryRouteGate({ children }: { children: React.ReactNode }) {
